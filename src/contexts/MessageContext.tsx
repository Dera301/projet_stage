...
export const MessageProvider: React.FC<MessageProviderProps> = ({ children }) => {
  ...
  const fetchConversations = useCallback(async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`http://nytranoko.infinityfree.me/api/messages/conversation.php?userId=${user.id}`);
  ...
  const fetchMessages = useCallback(async (conversationId: string) => {
    try {
      const response = await fetch(`http://nytranoko.infinityfree.me/api/messages/messages.php?conversationId=${conversationId}`);
  ...
  const sendMessage = async (receiverId: string, content: string): Promise<void> => {
    ...
    setLoading(true);
    try {
      const response = await fetch('http://nytranoko.infinityfree.me/api/messages/send.php', {
        method: 'POST',
        headers: {
  ...
  const markAsRead = async (messageId: string): Promise<void> => {
    try {
      const response = await fetch('http://nytranoko.infinityfree.me/api/messages/markAsRead.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
